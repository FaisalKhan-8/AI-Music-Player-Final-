...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan() {
    AlanVoice.addButton("e07795c4d7d3b825789f329f886fe1bf2e956eca572e1d8b807a3e2338fdd0dc/stage",
  ...
  fetchRadios() async {
    final radioJson = await rootBundle.loadString("assets/data.json");
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          [
            AppBar(
              title: "AI Music Player".text.xl2.bold.white.make().shimmer(
